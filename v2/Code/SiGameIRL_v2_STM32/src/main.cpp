...
const uint8_t PIN_PLAYERS[8] = {PB0, PA1, PA2, PA3, PB4, PB5, PB6, PA7};

const uint8_t PIN_JUDGE_MASTER = PA15;
const uint8_t PIN_JUDGE_SPECIAL = PB10;
const uint8_t PIN_JUDGE_RESERVED = PB11;
const uint8_t PIN_JUDGE_A_T_F = PA6;
const uint8_t PIN_JUDGE_A_P_1_4 = PA4;
const uint8_t PIN_JUDGE_A_P_5_8 = PA5;
