...
* Время на ответ игрока от 5 до 120 секунд, стандартные 30 секунд для рядового человека - нормальное время, в любом случае, каждый раз ждать по 30 секунд не придется, так как на кнопки правильно/неправильно можно нажать и во время ответа.
...
* Время пенальти при фальшстарте от 0 до 5 секунд (стд. 2). Если игрок кликает свою кнопку до начала отсчета времени реакции - ему назнеачается штраф в секундах, когда его кнопка не будет реагировать на нажатия.
...
3.2. При нажатии кнопки Master из этих игроков случайно выбирается один. Если вы хотите передать ход этому игроку - нажмите кнопку True, иначе - нажмите False.
